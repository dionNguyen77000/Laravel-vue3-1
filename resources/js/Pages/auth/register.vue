...
<div class="flex justify-center">
    <div class="w-11/12 bg-white p-6 roudned-lg">
        ...
        <h1 class="text-2xl text-white text-center font-bold bg-yellow-700 p-4 mb-4">Join Us</h1>
            <form action="#" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="username" id="username" placeholder="Username" class="bg-gray-100 border-2 w-full p-4 rounded-lg  @error('username') border-red-500 @enderror " >
                        <div class="text-red-500 mt-2 text-sm"></div>
                </div>
                <div class="mb-4">
                    <label for="email" class="sr-only"> Email </label>
                    <input type="text" name="email" id="email" placeholder="Your email" class="bg-gray-100 border-2 w-full p-4 rounded-lg  @error('email') border-red-500 @enderror" value="">
                        <div class="text-red-500 mt-2 text-sm"></div>
                </div>
                <div class="mb-4">
