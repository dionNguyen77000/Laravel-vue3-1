...
export default {
 ...
 computed: {
   ...
   methods: 
   {
        ...
        update () {
            axios.patch(`/api/datatable/suppliers/${this.editing.id}`, this.editing.form).then((response) => {
        ...
        destroy(record){
            ...
            axios.delete(`/api/datatable/suppliers/${record}`).then(()=>{
                this.selected= [],
