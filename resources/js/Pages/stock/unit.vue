 ...
 computed: {
   ...
   methods: {
            ...
            getRecords(){
                ...
                return axios.get(`/api/datatable/units?${this.getQueryParameters()}`).then((response)=> {
            ...
            update () {
                axios.patch(`/api/datatable/units/${this.editing.id}`, this.editing.form).then((response) => {
            ...
            store () {    
                ...
                axios.post(`/api/datatable/units`, this.creating.form).then((response) => {
            ...
            // console.log("🚀 ~ file: DataTable.vue ~ line 174 ~ destroy ~ record", record)
                ...
                axios.delete(`/api/datatable/units/${record}`).then(()=>{
                    this.selected= [],
