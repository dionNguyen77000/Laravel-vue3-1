  ...
  <div id="category" class="p-6"> 
        <div class="min-w-screen min-h-screen bg-gray-100 flex justify-center">
            ...
            <div class="flex justify-center" v-if="response.allow.creation && creating.active">
                ...
                <h3 class="text-xl text-gray text-center font-bold  p-3 mb-1">New Category</h3>
        ...
        <div class="my-2 flex sm:flex-row flex-col">
            ...
            <!-- start Table -->
                ...
                <div  v-if="filteredRecords.length" class="bg-white shadow-md rounded my-6  overflow-x-auto">
