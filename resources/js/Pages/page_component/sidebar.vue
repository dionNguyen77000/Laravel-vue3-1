<template>
    ...
    <div class="sticky top-24 z-30 left-0 bg-gray-900">
      ...
      <div class="mb-4 px-4">
        <div class="w-full flex justify-center md:justify-start items-center  text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          ...
          <!-- <router-link class="text-gray-500" :to="{name:'DashboardHome'}">Dashboard</router-link> -->
        </div>
        </div>
        
       <div class="mb-4 px-4">
        <p class="pl-4 text-md text-gray-50 text-center font-semibold mb-1">
        ...
        <div class="w-full flex justify-center md:justify-start items-center  text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          ...
          <span class="text-gray-500">Dashboard</span>
          <router-link class="text-gray-500" :to="{name:'Home'}">Dashboard</router-link>
        </div>
        ...
        <div class="w-full flex justify-center  md:justify-start items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          ...
          <router-link class="text-gray-500" :to="{name:'User_Management'}">Manage User</router-link>
        </div>
      </div>
      ...
      <div class="mb-4 px-4">
        ...
        <router-link class="text-gray-500" :to="{name:'Supplier'}">Suppliers</router-link>
        </div>
         <div class="w-full flex justify-center md:justify-start items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
         
                 <router-link class="text-gray-500" :to="{name:'Category'}">Categories</router-link>
