...
class Order_Head extends Model
{
    ...
    {
        return $this->hasMany(Order_Detail::class,'order_head_id','order_head_id');
    }
    ...
    public function getOrderDetails(){
        ...
        // $orderDetailsInTheOrder = Order_Detail::where('order_head_id',$this->order_head_id)
        $orderDetailsInTheOrder = $this->order_details
        ...
        foreach ($orderDetailsInTheOrder as $orderDetail) {
            if($orderDetail->menu_item_id>0){       
                ...
                // dd($theFamilyGroupOftheItem);     

                // if($theFamilyGroupOftheItem){
                //     var_dump($theFamilyGroupOftheItem);
                // }else {
            ...
            // $condimentsOfTheItem = Order_Detail::where('condiment_belong_item', $theItemId)->get();
    ...
    public function addOrderDetailToArrayGroup($theFamilyGroupArray,$theOrderDetail) {
        ...
        for ($i=0; $i < count($theFamilyGroupArray); $i++) { 
            ...
            if($theCurrentItemInArray->menu_item_name == $theOrderDetail->menu_item_name && $theCurrentItemInArray->unit ==  $theOrderDetail->unit && $theCurrentItemInArray->description == $theOrderDetail->description){
                ...
                // if both do not have conidment items match.
    ...
    public function getWaitingTime(){
        ...
        // $orderDetailsInTheOrder = Order_Detail::where('order_head_id',$this->order_head_id)->get();
        $orderDetailsInTheOrder = $this->order_details;
        // $orderDetails = [];
