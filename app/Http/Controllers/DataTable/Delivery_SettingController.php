...
class Delivery_SettingController extends DataTableController
{
    ...
    {
        return Delivery_Setting::query();
    }

    public function getCustomColumnsNames()
    {
        return [
            'duration_one_direction' => 'duration(1D)'
        ];
    }
    ...
    protected function getRecords(Request $request)
    {
        ...
        try {
            ...
            $pr = Delivery_SettingResourceDB::collection(
                $locations
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'suburb' => 'required',
            'zone' => 'required|unique:Delivery_Settings,zone',
        ]);
    ...
    public function update($id, Request $request)
    {
        $this->validate($request, [
            'suburb' => 'required',
            'zone' => 'required|unique:Delivery_Settings,zone,' . $id,
        ]);
